...
banner:
  ...
  fill_button:
    enable: true
    label: Book call
    link: https://calendly.com/supernova-intro/supernova-intro?month=2026-02
  outline_button:
    enable: true
  ...
  features:
    ...
    - title: SUPERNOVA
      ...
      list:
        ...
        - Hands-on execution / OKRs & outcomes
...
operating_alpha:
  ...
  content_box:
    ...
    list:
      - 5,000+ exited founders ($10M-$10B+ outcomes)
      - Matched by industry + growth stage
