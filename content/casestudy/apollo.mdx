...
Apollo launched with a consumer wearable and **grew to $10MM+ in annual revenues**. However, the company realized it could expand into a multi-factor platform to scale to its full potential and positively impact more live. This critical transition required additional capital, expanding revenue streams, proving GTM success, refactoring the team, and achieving key company milestones.

### Supernova Impact

* **FUNDING** - Supernova's exited founders accelerated the closing of a Series A ($30MM) by directly investing $350K, revamping the pitch deck, financials, deal room, investor outreach, running [Supernova demo days](https://kern.al/event/supernova-demo-day), as well as supporting meetings with insiders and VC's.
...
* **PARTNERSHIPS** - Referred and closed licensing deals to leverage Apollo’s patented software and prove it's hardware-agnostic and can be delivered through mobile phones, wearables, and any haptic devices that vibrate, such as headphones and smart beds.
...
* **COMMUNITY** - Spearheading a Kickstart campaign to pre-sell products for a Gen 2 launch leveraging the Apollo community.
